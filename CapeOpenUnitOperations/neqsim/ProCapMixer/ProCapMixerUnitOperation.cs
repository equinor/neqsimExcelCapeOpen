...
namespace CapeOpenUnitOperations
{
    ...
    public class ProCapMixerUnitOperation : UnitOperationBaseClass
    {
        ...
        public override void Initialize()
        {
            ...
            ((ParameterCollectionBaseClass)parameterCollection).AddParameter("Mixer DP", "Mixer DP", CapeParamMode.CAPE_INPUT, new ParameterRealSpec(), 1);
            // parameterCollection = new ParameterCollectionBaseClass();
        ...
        public override void Calculate()
        {
            ...
            ICapeThermoMaterial outMat = (ICapeThermoMaterial)((PortBaseClass)portCollection.Item("Port2")).connectedObject;
            try
            {
