...
namespace CapeOpenUnitOperations
{
    ...
    [Serializable]
    [Guid("A75BE056-4FD2-48B7-9B10-E7C929E3F05E")]
    [ClassInterface(ClassInterfaceType.AutoDispatch)]
    [ProgId("NeqSim.CapeOpen.Freezing")]

    public class FreezingUnitOperation : UnitOperationBaseClass
    {
        string[] reportNames = new string[1];
       

        public FreezingUnitOperation()
            : base()
        {
            componentDescription = "Freezing Temperature Unit";
            componentName = "Freezing Temperature Unit";
        }
        ...
        public override void Initialize()
        {
            ...
            ((ParameterCollectionBaseClass)parameterCollection).AddParameter("Freezing temperature", "Freezing temperature", CapeParamMode.CAPE_OUTPUT, new ParameterRealSpec(), 1);
            // parameterCollection = new ParameterCollectionBaseClass();
    ...
    //            return null;
        ...
        public static void RegisterFunction(Type t)
        {
           ...
           // const String ICapeOpenThermo = "{CF51E383-0110-4ed8-ACB7-B50CFDE6908E}";
            try
            {
                MemberInfo inf = typeof(FreezingUnitOperation);
                ...
                CapeDescription.SetValue("Name", "NeqSim Freezing Temperature Unit");
                CapeDescription.SetValue("Description", "NeqSim Freezing Temperature Unit");
