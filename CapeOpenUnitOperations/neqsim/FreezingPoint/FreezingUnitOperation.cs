...
namespace CapeOpenUnitOperations
{
    ...
    public class FreezingUnitOperation : UnitOperationBaseClass
    {
        ...
        public override void Initialize()
        {
            ...
            ((ParameterCollectionBaseClass) parameterCollection).AddParameter("Freezing temperature",
                "Freezing temperature", CapeParamMode.CAPE_OUTPUT, new ParameterRealSpec(), 1);
            // parameterCollection = new ParameterCollectionBaseClass();
